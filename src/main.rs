...
fn read_creds(path: &PathBuf) -> Result<Pve, Error> {
...
fn assemble_vv(data: &Value) -> String {
...
fn get_vv(pve: &Pve, vm: u8) -> Response<std::io::Cursor<Vec<u8>>> {
    ...
    let api = format!("https://{}/api2/json/nodes/brpo-pve/qemu/{}/spiceproxy", pve.address, vm.to_string());
    ...
    Response::from_string(assemble_vv(data))
